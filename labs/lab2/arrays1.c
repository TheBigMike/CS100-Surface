...
int main( ) {
    ...
    printf("X=%d, Y=%d, Z=%d\n",*P1,*P2,*P3);
	// using P1 and not X, change the variable Z's value from 1 to 10, then print it
    *P1 = 10;
    printf("%d\n",*P1);
	// using only P1 and P2 and P3, change the value of X to be 2 + 3 (Y + Z), then print X
    *P1 = (*P2+*P3);
    printf("%d\n",*P1);
